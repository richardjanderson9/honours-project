...
// Start: Change Modal Information!
    ...
    function change_information(parent_id){
        ...
        var json_tag = ("fingerprint_modal");
        ...
        $(function(){
            ...
            $.getJSON(json_location, function(json_location){
                ...
                if (parent_id == "data-1"){
                    var full_location_of_data = (json_location.fingerprint_modal.data_1);
                }
                else if (parent_id == "data-2"){
                    var full_location_of_data = (json_location.fingerprint_modal.data_2);
                }
                else if (parent_id == "data-3"){
                    var full_location_of_data = (json_location.fingerprint_modal.data_3);
                }
                else if (parent_id == "data-4"){
                    var full_location_of_data = (json_location.fingerprint_modal.data_4);
                }
                else if (parent_id == "data-5"){
                    var full_location_of_data = (json_location.fingerprint_modal.data_5);
                }
