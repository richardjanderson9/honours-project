...
function fingerprint_test_2(in_progress, reporting, complete, failed, delay_results, delay_test, colour_green, colour_red){
  // Information for the colour change!
  const id_varable_name = ("test_data_2"); // Sets ID Name (from '/fingerprint_tests/index.html') of Colour Change!
  const test_number = (2);
  const delay_check = (2);
