...
<body class="hide">
    ...
    <header class="formatting-center text-center">
        <div id="main-information-js" class="main-information-css">
            ...
            <p class="main-information">The information is currently being sent to the server; if you would like to remove it please press the button below!</p>
            <button id="start-test-js" class="header-button test-button" type="button" onclick="page_re_direct('destory');">Remove Data!</button>
        </div>
    </header>
